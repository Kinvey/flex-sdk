  ...
  function completionHandler(body) {
    ...
    const api = {
      ...
      next() {
        ...
        if (task.requestMetadata && task.requestMetadata.customRequestProperties) {
          task.request.headers['x-kinvey-custom-request-properties'] = JSON.stringify(task.requestMetadata.customRequestProperties);
        }
