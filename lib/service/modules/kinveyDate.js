...
function fromKinveyDateString(kinveyDateString, format) {
  if (isNil(format)) format = 'date';
  if (typeof kinveyDateString !== 'string' || !kinveyDateString.startsWith('ISODate("')) return 'Invalid date';
